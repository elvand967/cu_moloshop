...
# moloshop/apps/userpanel/templatetags/profile_menu.py

from django import template
from apps.userpanel.models.menu import ProfileMenuCategory

register = template.Library()

@register.inclusion_tag("userpanel/components/user_menu.html", takes_context=True)
